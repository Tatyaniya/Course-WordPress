...
?>
    ...
    <section class="inner events">
        <div class="wrapper">
            <div class="news">
                <h2 class="news__title secondary-title"><span><?php echo $wayup_options['news_title_1']; ?></span><br><?php echo $wayup_options['news_title_2']; ?></h2>

                <?php 
                    // проверка пагинации, на какой странице находимся
                    $news = ( get_query_var('paged') ) ? get_query_var('paged') : 1;

                    $news = new WP_Query( array(
                        'post_type' => 'news',
                        'paged' => $paged // грузить посты с той страницы, на которой находимся
                    ));
                    ...
                    <article class="news__item">
                        <div class="news__wrap">
                            <div class="news__img blue-noise">
                                ...
                                <ul class="tags-list">
                                    <!-- Термы текущей страницы -->
                                    <?php $news_category = wp_get_post_terms( get_the_ID(), 'news-category' );
                ...
                <?php 
                // Если страниц больше 1, показываем пагинацию
