...
<section class="inner clients">
	<div class="wrapper">
		<h2 class="clients__title secondary-title"><span><?php echo $wayup_options['testy_label-1']; ?></span><br><?php echo $wayup_options['testy_label-2']; ?></h2>
				...
				while ( $testimonials->have_posts() ) :  $testimonials->the_post(); ?>
					...
					<div class="clients__box">
						<div class="clients__photo">
							...
							<?php if($fb) { ?>
								<a href="<?php echo esc_url($fb); ?>" class="clients__link" target="_blank">
