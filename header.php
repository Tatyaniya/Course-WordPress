...
// print_r($wayup_options['header_bg']);

// print_r($wayup_options['home_header_slider']);
...
<!--<?php $test = get_option('themename_theme_options'); echo $test['color_scheme']; ?>-->
	...
	<header class="header <?php echo esc_attr($class_header); ?>" <?php echo $style_for_header; ?>>
		...
		<div class="heading">
			...
			<div class="heading__block">
                ...
                <?php
                if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins')))) { global $woocommerce; ?>
