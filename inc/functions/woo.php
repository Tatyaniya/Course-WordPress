<?php if ( in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins')))) {
    ...
    function wayup_woo_sku_custom() {
        ...
        <div class="availability 
            <?php $tovar = $product->get_availability();
    ...
    function wayup_custom_share() { ?>
        <div class="share">
            ...
            <ul class="social">
                ...
                <li class="social__item">
                    <span>Tw</span>
                    <a data-social="twitter" onclick="window.open(this.href, 'Share on Twitter', 'width=600, height=300'); return false" class="social__icon social__icon_tw" href="<?php echo wayup_get_share('twi', get_the_permalink(), get_the_title()); ?>">
...
// опускаем форму комментариев ниже полей
...
// отключить кнопку отправки комментария на странице товара
...
add_filter( 'woocommerce_cart_item_price', 'my_custom_show_sale_price_at_cart', 10, 3 );
    ...
    /*add_action( 'after_setup_theme', 'wayup_woocommerce_plugin_setup' );

    function wayup_woocommerce_plugin_setup() {
    ...
    // удаляем описание категорий
    remove_action('woocommerce_archive_description', 'woocommerce_taxonomy_archive_description', 10);
    // удаляем описание продукта
    remove_action('woocommerce_archive_description', 'woocommerce_product_archive_description', 10);

    // переносим уведомления выше
    ...
    // добавляем закрывающий тег ссылки
    add_action('woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_product_link_close', 15);
    // удаляем закрывающий тег ссылки в последнем хуке
