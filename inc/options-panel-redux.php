<?php
    ...
    // Создать переменную для настроек
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'social_links',
                'type'     => 'sortable',
                'title'    => esc_html__( 'Social Lincs', 'wayup' ),
                'subtitle' => esc_html__( 'Insert links for your Social Profiles', 'wayup' ),
                'desc'     => esc_html__( 'Let the field empty if you don\'t have a link', 'wayup' ),
                'label'    => true,
                'options'  => array(
                    'Vkontakte'   => '',
                    'Facebook'   => '',
    ...
    Redux::setSection( $opt_name, array(
        ...
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => esc_html__( 'Add Contacts Data for header and footer', 'wayup' ),
        'fields'           => array(
            array(
                'id'       => 'header-start',
                'type'     => 'section',
            ...
            array(
                ...
                'desc'     => esc_html__( 'Add ore remove items', 'wayup' ),
            ),
            array(
                'id'       => 'footer_email',
                'type'     => 'text',
            ...
            array(
                ...
                'type'    => 'editor',
                'title'   => esc_html__( 'Copyrigthts', 'wayup' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                ...
                'type'     => 'media',
                'url'      => true,
                'title'    => esc_html__( 'Background for Home Header', 'wayup' ),
                'compiler' => 'true',
                'desc'     => esc_html__( 'Recommended size 1920px-998px', 'wayup' ),
            ...
            array(
                'id'       => 'header_video',
                'type'     => 'text',
                'title'    => esc_html__( 'Specify the video link', 'wayup' ),
                'default' => '',
                'text_hint' => array(
                    'title'   => 'Ссылка с YouTube',
                    'content' => 'Используйте ссылку из строки браузера на ролик с youtube'
                )
            ),
            array(
                'id'       => 'header_video_title',
                'type'     => 'text',
                'title'    => esc_html__( 'Specify the video title', 'wayup' ),
                'default' => ''
            ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'fields'           => array(
            array(
                'id'       => 'testy_label-1',
                'type'     => 'text',
                'title'    => esc_html__( 'Specify the Label 1', 'wayup' ),
                'default'  => 'За нас говорят'
            ),
            array(
                'id'       => 'testy_label-2',
                'type'     => 'text',
                'title'    => esc_html__( 'Specify the Label 2', 'wayup' ),
            ...
            array(
                ...
                'desc'     => 'Установите плагин и введите шорт код контактной формы в это поле',
                'default'  => ''
            ),
        ) 
    ) );
    ...
    Redux::setSection( $opt_name, array(
        'title'            => esc_html__( 'Services', 'wayup' ),
        'id'               => 'services_post_type',
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => esc_html__( 'Data for Sevice Page', 'wayup' ),
        'fields'           => array(
            array(
                'id'       => 'service_currency',
                'type'     => 'text',
                'title'    => esc_html__( 'Specify the Currency', 'wayup' ),
                'default'  => '$'
            ),
            array(
                'id'       => 'cases_label',
                'type'     => 'text',
                'title'    => esc_html__( 'Заголовок для слайдера из кейсов', 'wayup' ),
                'default'  => 'Посмотрите наши последние кейсы'
            ),
            array(
                'id'       => 'service_archive_title_1',
                'type'     => 'text',
                'title'    => esc_html__( 'Заголовок 1 Страницы Архив', 'wayup' ),
                'default'  => 'Наши'
            ),
            array(
                'id'       => 'service_archive_title_2',
                'type'     => 'text',
                'title'    => esc_html__( 'Заголовок 2 Страницы Архив', 'wayup' ),
                'default'  => 'услуги'
            ),
            array(
                'id'       => 'service_archive_desc',
                'type'     => 'text',
                'title'    => esc_html__( 'Описание страницы Архив', 'wayup' ),
    ...
    Redux::setSection( $opt_name, array(
        ...
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => 'Опции для страницы Новости',
        'fields'           => array(
            array(
                'id'       => 'news_title_1',
                'type'     => 'text',
                'title'    => 'Заголовок часть 1',
                'default'  => 'Актуальные'
            ),
            array(
                'id'       => 'news_title_2',
                'type'     => 'text',
                'title'    => 'Заголовок часть 2',
                'default'  => 'новости'
            ),
            array(
    ...
    Redux::setSection( $opt_name, array(
        ...
        'subsection'       => true,
        'customizer_width' => '450px',
        'desc'             => 'Опции для страницы Магазина',
        'fields'           => array(
            array(
                'id'       => 'woo_title_1',
                'type'     => 'text',
            ...
            array(
                ...
                'default'  => array( 'url' => get_template_directory_uri().'/assets/img/shop-bg.jpg' ),
            ),
        )
    ) );
