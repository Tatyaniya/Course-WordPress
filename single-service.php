...
<section class="inner service">
            ...
            // проверка, что выводится в селекте фоновой картинки
            //echo get_metadata('post', get_the_ID(), 'wayup_service_icon', true);
            ?>
			    ...
			    <div class="inner__content">
					...
					<div class="inner__img blue-noise">
						...
						<span class="inner__price"><?php echo $wayup_options['service_currency']; echo get_metadata('post', get_the_ID(), 'wayup_service_cost', true); ?></span>
					</div>
			...
			<!-- Slider -->
				<div class="cases">
					<h4 class="cases__cap"><?php if($wayup_options['cases_label']) {echo $wayup_options['cases_label'];} else {echo esc_html_e('Latest Cases', 'wayup');} ?></h4>
					<div class="cases__slider">
                        ...
                        wp_reset_postdata();
                                ...
                                echo '<div>Нет кейсов в базе</div>';
                            endif;
                        ?>
					</div>
				</div>
