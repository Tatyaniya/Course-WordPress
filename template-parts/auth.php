		...
		<div id="enter" class="login mfp-hide">
            ...
            <form id="log" class="log" method="post">
                ...
                <div class="log__group">
					...
					<input type="text" name="username" class="log__input" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>">
				</div>
                ...
                <div class="log__wrap">
                    ...
                    <!-- перекидываем на второе модальное окно -->
...
<!-- Forget password -->
		<div id="recovery" class="recovery mfp-hide">
			<div class="forget">
                ...
                <form action="<?php echo home_url('/lk'); ?>" method="post" id="recover" class="log">
...
<!-- Registration -->
        ...
        <form method="post" id="regist" class="log" >
            ...
            <div class="log__wrap">
                <div class="log__btn">
                    <input id="do-reg" type="submit" value="Зарегистрироваться" class="btn" name="register" />
                </div>
