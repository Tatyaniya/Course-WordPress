...
<section class="inner shop">
    <div class="shop-top" style="background: #fff url(<?php echo $wayup_options['woo_bg']['url']; ?>) no-repeat center top/ cover;">
        <div class="wrapper">
            <?php if($wayup_options['woo_title_1'] or $wayup_options['woo_title_2']) { ?>
                <h1 class="shop-top__title">
                    <?php echo $wayup_options['woo_title_1']; ?> <br><span><?php echo $wayup_options['woo_title_2']; ?></span>
                </h1>
            <?php } ?>
            <?php if($wayup_options['woo_link']) { ?>
                <a href="<?php echo $wayup_options['woo_link']; ?>" class="shop-top__btn btn">Купить сейчас</a>
            <?php } ?>
        </div>
    </div>
        ...
        <div class="shop__heading">
            ...
            <div class="sort-menu">
                ...
                <ul>
                    ...
                    <li><a href="#" data-value="price">по возрастанию цены</a></li>
                    <li><a href="#" data-value="price-desc">по убыванию цены</a></li>
                </ul>
            </div>
        </div>
