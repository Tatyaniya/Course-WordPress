    ...
    <div <?php comment_class('clients__box'); ?> id="li-comment-<?php comment_ID(); ?>">
        <div class="clients__photo">
            <div class="clients__img">
                ...
                $comment_autor_id = $comment->user_id;
                
                echo get_avatar($comment_autor_id, 250); ?>
            </div>
        ...
        <div class="clients__say">
            <p class="clients__name"><?php comment_author(); ?> <?php if(current_user_can('manage_options') && get_comment_meta( get_comment_ID(), 'phone', true )){
